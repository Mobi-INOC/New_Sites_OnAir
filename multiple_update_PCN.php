...
if (isset($_POST['hidden_id'])) {
  ...
  $pcn_config_by = $_SESSION['user_name'];
  ...
  for ($count = 0; $count < count($id); $count++) {
    ...
    $query = "
  UPDATE sites 
  SET pcn_config_status = :pcn_config_status, pcn_remark = :pcn_remark, pcn_config_by = :pcn_config_by, pcn_config_date = :pcn_config_date
  WHERE id = :id
  ";
